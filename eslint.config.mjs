...
export default [
  {
    ignores: [
      ...
      "libs/ts-observability/src/**/*.js",
      "libs/ts-observability/src/**/*.js.map",
      "libs/ts-observability/src/**/*.d.ts",
      "libs/ts-observability/src/**/*.d.ts.map",
      "**/tailwind.config.ts",
      "**/vitest.config.ts",
      "**/*.test.ts",
      "**/*.test.tsx",
  ...
  },
  {
    ...
    files: [
      ...
      "services/compliance-svc/**/*.{ts,tsx}",
