 ...
 * Uses the AdminAuthService for authentication and authorization.
 *
...
export const adminRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get(
    '/users',
    {
      preHandler: [requirePermissions('admin:manage')],
    },
    async (request, reply) => {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      ...
      const authService = getAdminAuthService(prisma);
      const { email, name, password, role, allowedIPs } = request.body as {
        email: string;
        name: string;
        password: string;
  ...
  fastify.patch(
    ...
    async (request, reply) => {
      ...
      const admin = await authService.updateAdmin(adminId, updates, session.adminId, context);
  ...
  fastify.delete(
    ...
    async (request, reply) => {
      ...
      await authService.deactivateAdmin(adminId, session.adminId, context);
  ...
  fastify.post(
    ...
    {
      preHandler: [requirePermissions('partner:write')],
    },
    async (request, reply) => {
      const { partnerId } = request.params as { partnerId: string };
  ...
  fastify.post(
    '/tenants/:tenantCode/generate-data',
    {
      preHandler: [requirePermissions('sandbox:manage')],
    },
    async (request, reply) => {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      ...
      await prisma.$transaction([
        ...
        prisma.sandboxSyntheticLearnerProgress.deleteMany({
          where: { learner: { tenantId: tenant.id } },
        }),
  ...
  // Get usage analytics
  fastify.get(
    '/tenants/:tenantCode/usage',
    {
      preHandler: [requirePermissions('sandbox:read')],
    },
    async (request, reply) => {
      const { tenantCode } = request.params as { tenantCode: string };
      ...
      // Get daily totals
      const dailyUsage = await prisma.$queryRaw<{ date: string; count: number }[]>`
