...
export class InsightsService {
    ...
    for (const insight of insights) {
      await this.prisma.benchmarkInsight.create({
        data: {
          ...
          metricKey: insight.metricKey ?? null,
          currentValue: insight.currentValue ?? null,
          peerAverage: insight.peerAverage ?? null,
          percentile: insight.percentile ?? null,
  ...
  async getInsights(
    ...
    return insights.map((i: InsightRecord) => ({
      ...
      ...(i.metricKey != null && { metricKey: i.metricKey }),
      ...(i.currentValue != null && { currentValue: i.currentValue }),
      ...(i.peerAverage != null && { peerAverage: i.peerAverage }),
      ...(i.percentile != null && { percentile: i.percentile }),
      ...(i.recommendation != null && { recommendation: i.recommendation }),
      priority: i.priority,
    }));
  }
