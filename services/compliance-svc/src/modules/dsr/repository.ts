/**
 * DSR Repository – Raw PG data-access layer
 *
 * All DSR CRUD operations against the compliance database.
 * Uses the shared pg Pool from the consolidated compliance-svc.
 *
