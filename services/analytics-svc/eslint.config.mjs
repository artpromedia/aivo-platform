...
export default [
  ...sharedConfig,
  {
    rules: {
      ...
      // for clarity or for handling union types
      ...
      // Disable no-redeclare - TypeScript allows const + type with same name
      'no-redeclare': 'off',
      // Downgrade use-unknown-in-catch-callback-variable to warning
      '@typescript-eslint/use-unknown-in-catch-callback-variable': 'warn',
      // Downgrade no-base-to-string to warning - values are actually primitives at runtime
