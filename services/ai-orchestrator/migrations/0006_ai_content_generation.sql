...
COMMENT ON TABLE ai_generation_log IS 'Detailed log of all AI content generation requests. Used for: - Debugging and troubleshooting - Cost tracking and analytics - Performance monitoring - Audit trail';
