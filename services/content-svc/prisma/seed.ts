      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'What are Fractions?' },
          {
            type: 'paragraph',
            content:
              'A fraction represents a part of a whole. Think of cutting a pizza into equal slices!',
          },
          {
            type: 'image',
            src: '/content/fractions/pizza-example.png',
            alt: 'Pizza divided into 8 slices',
          },
          {
            type: 'interactive',
            subtype: 'fraction-visualizer',
            config: { defaultNumerator: 1, defaultDenominator: 4 },
          },
          {
            type: 'paragraph',
            content:
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'Adding Fractions' },
          {
            type: 'paragraph',
            content:
              'When fractions have the same denominator, adding them is easy! Just add the numerators.',
          },
    ...
    },
    {
      ...
      content: {
        blocks: [
          ...
          {
            type: 'paragraph',
            content: 'Practice your multiplication facts with fun games and challenges!',
          },
          {
            type: 'interactive',
            subtype: 'times-table-drill',
            config: { maxFactor: 12, timeLimit: 60 },
          },
        ],
        estimatedMinutes: 10,
        difficulty: 'beginner',
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'Understanding What You Read' },
          {
            type: 'paragraph',
            content:
              'Good readers use strategies to help them understand and remember what they read.',
          },
          {
            type: 'list',
            items: [
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'Words Have Jobs!' },
          {
            type: 'paragraph',
            content:
              "Every word in a sentence has a special job. Let's learn about nouns, verbs, and adjectives!",
          },
          ...
          { type: 'definition', term: 'Adjective', definition: 'A describing word' },
          {
            type: 'interactive',
            subtype: 'word-sort',
            config: { categories: ['Noun', 'Verb', 'Adjective'] },
          },
        ],
        estimatedMinutes: 15,
        difficulty: 'beginner',
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'The Amazing Water Cycle' },
          {
            type: 'paragraph',
            content:
              'Water is always moving! It goes up into the sky and comes back down as rain or snow.',
          },
          {
            type: 'image',
            src: '/content/science/water-cycle-diagram.png',
            alt: 'Water cycle diagram',
          },
          {
            type: 'definition',
            term: 'Evaporation',
            definition: 'When water heats up and turns into water vapor',
          },
          {
            type: 'definition',
            term: 'Condensation',
            definition: 'When water vapor cools and forms clouds',
          },
          {
            type: 'definition',
            term: 'Precipitation',
            definition: 'When water falls from clouds as rain, snow, sleet, or hail',
          },
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'How Am I Feeling?' },
          {
            type: 'paragraph',
            content:
              'Everyone has feelings! Learning to name your feelings helps you understand yourself better.',
          },
          {
            type: 'interactive',
            subtype: 'emotion-wheel',
            config: { emotions: ['happy', 'sad', 'angry', 'scared', 'surprised', 'calm'] },
          },
          {
            type: 'paragraph',
            content: "It's okay to feel any emotion. What matters is how we handle our feelings.",
          },
        ],
        estimatedMinutes: 10,
        difficulty: 'beginner',
      ...
      content: {
        blocks: [
          { type: 'heading', level: 1, content: 'When I Need to Calm Down' },
          {
            type: 'paragraph',
            content:
              'Sometimes we feel big emotions that are hard to control. Here are some things that can help:',
          },
          {
            type: 'list',
            items: [
          ...
          {
            type: 'interactive',
            subtype: 'breathing-exercise',
            config: { type: 'box-breathing', seconds: 4 },
          },
        ],
        estimatedMinutes: 10,
        difficulty: 'beginner',
