...
export function buildSensoryContentFilter(
  ...
  if (isVeryHighSensitivity(getSensitivityLevel(profile.audioSensitivity))) {
    ...
    isHighSensitivity(getSensitivityLevel(profile.audioSensitivity)) &&
    strictness !== 'relaxed'
  ) {
    conditions.push({
  ...
  if (isVeryHighSensitivity(getSensitivityLevel(profile.visualSensitivity))) {
    conditions.push({
  ...
  if (isVeryHighSensitivity(getSensitivityLevel(profile.motionSensitivity))) {
