...
import type { ContentSensoryMetadata as PrismaContentSensoryMetadata } from '../prisma-types.js';

// Re-export Prisma type for convenience
export type ContentSensoryMetadata = PrismaContentSensoryMetadata;
...
export interface SensoryProfile {
  ...
  photosensitivityLevel: number | null;
  needsFrequentBreaks: boolean;
  preferredBreakFrequency: string;
