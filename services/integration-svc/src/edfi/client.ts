...
import type { EdfiTokenResponse, EdfiApiError, EdfiResource } from './types.js';
...
export class EdfiClient {
  private readonly config: EdfiClientConfig;
  private readonly options: EdfiClientOptions;
