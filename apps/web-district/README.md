...
- Ensure district admins receive JWTs with roles that include `DISTRICT_ADMIN`; these are forwarded to compliance-svc for aggregates.

## Privacy page integration

- Configure `COMPLIANCE_SVC_URL` to point at compliance-svc (default `http://localhost:4004`).
