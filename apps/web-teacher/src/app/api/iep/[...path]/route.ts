/**
 * IEP Service API Proxy
 *
 * Proxies all /api/iep/* requests to iep-svc (port 4070).
 * For example:
 *   GET  /api/iep/students        → iep-svc GET  /students
 *   GET  /api/iep/ieps/dashboard   → iep-svc GET  /ieps/dashboard
 *   POST /api/iep/ieps/:id/goals   → iep-svc POST /ieps/:id/goals
