...
const partnerTiers: PartnerTier[] = [
  {
    ...
    description:
      'Recommend AIVO to schools and families and earn rewards for every successful introduction.',
    icon: HeartHandshake,
  ...
  },
  {
    ...
    description:
      'Build integrations between AIVO and your EdTech product to deliver a seamless experience for shared users.',
    icon: Zap,
  ...
  },
  {
    ...
    description:
      'Deep collaboration for districts, publishers, and organisations committed to inclusive education at scale.',
    icon: Building2,
...
const partnerTypes = [
  {
    ...
    description:
      'Bring AIVO to your classrooms with dedicated district support and FERPA-compliant deployment.',
  },
  {
    icon: BookOpen,
    title: 'Content Publishers',
    description: `Integrate your curriculum into AIVO's adaptive learning engine for wider reach.`,
  },
  {
    icon: Globe,
    title: 'EdTech Companies',
    description: 'Build integrations that create seamless experiences for educators and learners.',
  },
  {
    icon: BarChart3,
    title: 'Research Institutions',
    description: 'Collaborate on studies in neurodiversity, AI in education, and learning science.',
  },
  {
    icon: Users,
    title: 'Non-Profits & Advocates',
    description:
      'Partner to expand access to inclusive education tools for underserved communities.',
  },
  {
    icon: Handshake,
    title: 'Consultants & Resellers',
    description:
      'Add AIVO to your portfolio and help schools find the right inclusive learning solution.',
  },
];
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Partner With <span className="text-gradient-primary">AIVO</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Together we can make inclusive, AI-powered education accessible to every learner.
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600 max-w-xl mx-auto">
                From referral partnerships to deep strategic collaborations — find the right fit.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {partnerTiers.map((tier, i) => (
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${tier.color} flex items-center justify-center mb-5`}
                  >
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-600 max-w-xl mx-auto">
                We work with organisations across the education ecosystem.
              </p>
            </motion.div>
