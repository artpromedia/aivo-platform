  ...
  static final multiplicationGoal = IepGoal(
    ...
    progressHistory: [
      IepProgress(
        ...
        goalId: 'goal-mult-1',
        value: 50,
        note: 'Initial assessment after summer break',
      ...
      IepProgress(
        ...
        goalId: 'goal-mult-1',
        value: 62,
        note: 'Showing improvement with 6s and 7s',
      ...
      IepProgress(
        ...
        goalId: 'goal-mult-1',
        value: 72,
        note: 'Consistent progress, needs work on 8s and 9s',
  ...
  static final readingComprehensionGoal = IepGoal(
    ...
    progressHistory: [
      ...
      IepProgress(
        ...
        goalId: 'goal-reading-1',
        value: 65,
        note: 'Responding well to graphic organizers',
  ...
  static final writingGoal = IepGoal(
    ...
    progressHistory: [
      IepProgress(
        ...
        value: 2,
        note: 'Can write introduction and body paragraph',
      ...
      IepProgress(
        ...
        goalId: 'goal-writing-1',
        value: 3,
        note: 'Added conclusion, working on transitions',
  ...
  static final behaviorGoal = IepGoal(
    ...
    progressHistory: [
      IepProgress(
        ...
        value: 8,
        note: 'Using timer and break cards',
      ...
      IepProgress(
        ...
        goalId: 'goal-behavior-1',
        value: 12,
        note: 'Consistent improvement with movement breaks',
