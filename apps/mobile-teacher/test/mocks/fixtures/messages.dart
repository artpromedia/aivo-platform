...
class TestMessages {
  ...
  static final sampleConversation = Conversation(
    ...
    participantIds: const ['parent-johnson', 'teacher-1'],
    participantNames: const ['Sarah Johnson', 'Test Teacher'],
  ...
  static final secondConversation = Conversation(
    ...
    participantIds: const ['parent-williams', 'teacher-1'],
    participantNames: const ['James Williams', 'Test Teacher'],
