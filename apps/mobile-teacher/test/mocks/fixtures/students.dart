...
class TestStudents {
  ...
  static final alex = Student(
    ...
    classIds: const ['class-math-5', 'class-reading-5'],
    avatarUrl: null,
    gradeLevel: 5,
    ...
    hasIep: true,
    has504: false,
    parentEmails: const ['parent.johnson@email.com'],
    accommodations: const ['extended_time', 'text_to_speech', 'reduced_distractions'],
  ...
  static final emma = Student(
    ...
    hasIep: false,
    has504: false,
    parentEmails: const ['williams.family@email.com'],
  ...
  static final jordan = Student(
    ...
    hasIep: false,
    has504: true,
    parentEmails: const ['smith.parents@email.com'],
    accommodations: const ['frequent_breaks', 'preferential_seating'],
  ...
  static final marcus = Student(
    ...
    hasIep: false,
    has504: false,
    parentEmails: const ['chen.family@email.com'],
    accommodations: const [],
    lastActiveAt: null,
  ...
  static final sofia = Student(
    ...
    classIds: const ['class-reading-5'],
    avatarUrl: null,
    gradeLevel: 5,
    ...
    hasIep: true,
    has504: false,
    parentEmails: const ['rodriguez.family@email.com'],
    accommodations: const ['audio_books', 'graphic_organizers'],
  ...
  static const inactiveStudent = Student(
    id: 'student-inactive',
    firstName: 'Taylor',
    lastName: 'Brown',
