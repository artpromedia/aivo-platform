/// Startup Checks for Mobile Learner App
///
...
class StartupChecks {
  ...
  static void _checkMockModeConfiguration() {
    if (kReleaseMode && EnvironmentConfig.useMockServices) {
      ...
      throw StateError(
        ...
        'This is a security violation for child authentication. Build is invalid.',
      );
    }
  }
  ...
  static bool _hasLocalhostUrl() {
    final urls = [
      ...
      EnvironmentConfig.learnerModelBaseUrl,
      EnvironmentConfig.analyticsBaseUrl,
      EnvironmentConfig.focusBaseUrl,
    ];
  ...
  static void _logStartupInfo() {
    debugPrint('═══════════════════════════════════════════════════════════');
    debugPrint('🎒 AIVO Learner App - Startup Checks');
    debugPrint('═══════════════════════════════════════════════════════════');
    ...
    debugPrint('Learner URL: ${EnvironmentConfig.learnerBaseUrl}');
    debugPrint('═══════════════════════════════════════════════════════════');
  }
