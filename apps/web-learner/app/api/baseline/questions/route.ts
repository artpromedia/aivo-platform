  ...
  MATH: {
    ...
    MODIFIED: [
      ...
      },
      {
        ...
        skillCode: 'MATH_OPERATIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'You have 5 cookies. You eat 2. How many left?',
        options: ['2', '3', '4'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'MATH_FRACTIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Cut the pizza in half. How many pieces?',
        options: ['1', '2', '3'],
        difficulty: 1,
        questionNumber: 3,
      },
      ...
      },
      {
        ...
        skillCode: 'MATH_PROBLEM_SOLVING',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'You have 2 toys. Mom gives you 1 more. How many?',
        options: ['2', '3', '4'],
        difficulty: 1,
        questionNumber: 5,
      },
    ...
    ALTERNATE: [
      {
        ...
        skillCode: 'MATH_NUMBER_SENSE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Show me 2 fingers. 🖐️',
        options: ['I can do it', 'I need help'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'MATH_OPERATIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Which is more? 🍎🍎🍎 or 🍎?',
        options: ['3 apples 🍎🍎🍎', '1 apple 🍎'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'MATH_FRACTIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Share the cookie with a friend. Each person gets...',
        options: ['A piece', 'Nothing'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'MATH_GEOMETRY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Point to something round in the room.',
        options: ['I found it!', 'Help me find it'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
  ...
  ELA: {
    STANDARD: [
      ...
      },
      {
        ...
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'In "The Three Little Pigs", what did the wolf try to do?',
        options: [
          'Help build houses',
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'ELA_PHONEMIC_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Cat sounds like... 🐱',
        options: ['Hat 🎩', 'Dog 🐕', 'Bird 🐦'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'ELA_VOCABULARY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Happy means feeling... 😊',
        options: ['Good 😊', 'Sad 😢', 'Angry 😠'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'ELA_FLUENCY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'The dog ___. (runs or run)',
      ...
      },
      {
        ...
        skillCode: 'ELA_COMPREHENSION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'The wolf tried to blow down the house. True? 🐺💨🏠',
        options: ['Yes, true', 'No, false', "I don't know"],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'ELA_WRITING',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Questions end with...',
        options: ['? (question mark)', '. (period)', '! (exclamation)'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ALTERNATE: [
      {
        ...
        skillCode: 'ELA_PHONEMIC_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Point to the picture that starts with "B". 🏀🍎',
        options: ['Ball 🏀', 'Apple 🍎'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'ELA_VOCABULARY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Show me your happy face. 😊',
        options: ['I did it!', 'Help me'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'ELA_FLUENCY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Say your name.',
        options: ['I said it!', 'I need help'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
      ...
      },
      {
        ...
        skillCode: 'ELA_WRITING',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Write your first letter of your name.',
        options: ['I wrote it!', 'Help me write'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
  ...
  SPEECH: {
    STANDARD: [
      ...
      },
      {
        ...
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'How should you speak when someone is sleeping?',
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'SPEECH_ARTICULATION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: '"Sun" starts with... ☀️',
        options: ['S sound 🐍', 'B sound', 'T sound'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'SPEECH_FLUENCY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Talk clearly so others can hear. 🗣️',
        options: ['Yes, I can', 'Sometimes', 'I need help'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SPEECH_VOICE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Baby sleeping. Use... 👶💤',
        options: ['Quiet voice 🤫', 'Loud voice 📢', 'No voice'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
      ...
      },
      {
        ...
        skillCode: 'SPEECH_PRAGMATICS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'When you meet someone, say... 👋',
    ...
    ALTERNATE: [
      {
        ...
        options: ['I said it!', 'Help me say it'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'SPEECH_FLUENCY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Tell me your name.',
        options: ['I told you!', 'I need help'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SPEECH_VOICE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Use your quiet voice. 🤫',
        options: ['I did it!', 'Show me how'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'SPEECH_LANGUAGE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Point to something big. 🐘',
        options: ['I found one!', 'Help me find it'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'SPEECH_PRAGMATICS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Wave to say goodbye. 👋',
        options: ['I waved!', 'Show me how'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'SEL_SELF_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'When angry, I can... 😤',
        options: ['Breathe deep 🌬️', 'Hit things 👊', 'Yell 😠'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'SEL_SELF_MANAGEMENT',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Work is hard. I should...',
        options: ['Ask for help 🙋', 'Give up 😔', 'Get angry 😠'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SEL_SOCIAL_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Friend is sad. 😢 I can...',
        options: ['Ask "Are you OK?"', 'Laugh at them', 'Walk away'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Good friends... 👫',
        options: ['Share toys', 'Fight a lot', 'Ignore each other'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'SEL_DECISIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Before choosing, I think... 🤔',
        options: ['What will happen?', 'Just do it fast', 'Ask a stranger'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ALTERNATE: [
      {
        ...
        skillCode: 'SEL_SELF_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Show me a happy face. 😊',
        options: ['I did it!', 'Help me'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'SEL_SELF_MANAGEMENT',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Take 3 deep breaths. 🌬️',
        options: ['I did it!', 'Breathe with me'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SEL_SOCIAL_AWARENESS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Give a friend a high five. 🙌',
        options: ['I did it!', 'Help me'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'SEL_RELATIONSHIPS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Share a toy with a friend. 🧸',
        options: ['I shared!', 'I need help sharing'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'SEL_DECISIONS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Pick: cookie 🍪 or apple 🍎?',
        options: ['I picked one!', 'Help me decide'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'SPELL_PATTERNS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Pick the right spelling: CAT 🐱',
      ...
      },
      {
        ...
        skillCode: 'SPELL_PHONICS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'DOG starts with D. Pick D-O-G.',
        options: ['dog', 'bog', 'doog'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SPELL_RULES',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'More than one cat = ...',
      ...
      },
      {
        ...
        skillCode: 'SPELL_COMPOUND',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'CUP + CAKE = ?',
        options: ['cupcake', 'cup cake', 'cupcak'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ALTERNATE: [
      {
        ...
        skillCode: 'SPELL_PATTERNS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Find the letter A',
        options: ['I found it!', 'Show me'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'SPELL_PHONICS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'What letter does CAT start with?',
        options: ['C', 'A', 'T'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'SPELL_RULES',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Point to your name.',
        options: ['I found it!', 'Help me'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'SPELL_SIGHT_WORDS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Find the word THE',
        options: ['I found it!', 'Show me'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'SPELL_COMPOUND',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Write the first letter of your name.',
        options: ['I did it!', 'Help me write'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
  ...
  CREATIVE_WRITING: {
    STANDARD: [
      ...
      },
      {
        ...
        options: ['Only write facts', 'Make up stories', 'Copy from books', 'Only use real people'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'CW_STORY_ELEMENTS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Stories have a start 📖 and...',
        options: ['An end 🔚', 'A picture only', 'Nothing else'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'CW_CHARACTER',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'A character is...',
        options: ['A person in the story 👧', 'The place', 'The title'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'CW_SETTING',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Setting = where the story happens. 🏠🌳',
      ...
      },
      {
        ...
        skillCode: 'CW_DESCRIPTIVE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Which tells more? "Big red ball" or "Ball"?',
        options: ['Big red ball 🔴', 'Ball', 'Both the same'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'CW_IMAGINATION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Can you make up a story? 📝✨',
        options: ['Yes!', 'Only true stories', 'No stories'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ALTERNATE: [
      {
        ...
        skillCode: 'CW_STORY_ELEMENTS',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Tell me what happens first in your day. 🌅',
        options: ['I told you!', 'Help me think'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        options: ['I have one!', 'Help me think'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'CW_SETTING',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Where is your favorite place? 🏠',
        options: ['I know one!', 'Help me think'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'CW_DESCRIPTIVE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'What color is the sky? ☁️',
        options: ['I know!', 'Show me'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'CW_IMAGINATION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Draw anything you want! 🎨',
        options: ['I drew it!', 'Help me draw'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
  ...
  LIFE_SKILLS: {
    STANDARD: [
      ...
      },
      {
        ...
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'If something costs $3 and you have $5, how much change?',
        options: ['$1', '$2', '$3', '$8'],
        difficulty: 2,
        questionNumber: 2,
      },
      ...
      },
      {
        ...
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Keeping things organized helps you...',
    ...
    MODIFIED: [
      {
        ...
        skillCode: 'LIFE_TIME',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'We eat lunch when? 🍽️🕛',
        options: ['In the middle of the day', 'At bedtime', 'When we wake up'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'LIFE_MONEY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'You have $2. 💵💵 The toy costs $1. Can you buy it?',
        options: ['Yes! ✓', 'No, not enough', "I don't know"],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'LIFE_SAFETY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Before crossing the street... 🚶‍♂️🛣️',
        options: ['Look left and right 👀', 'Run fast 🏃', 'Close eyes 😵'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'LIFE_HYGIENE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Wash hands before eating? 🧼🍎',
      ...
      },
      {
        ...
        skillCode: 'LIFE_ORGANIZATION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Put toys away helps me... 🧸📦',
        options: ['Find them later', 'Lose them', 'Make a mess'],
        difficulty: 1,
        questionNumber: 5,
      },
    ],
    ALTERNATE: [
      {
        ...
        skillCode: 'LIFE_TIME',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Point to the clock. ⏰',
        options: ['I found it!', 'Show me'],
        difficulty: 1,
        questionNumber: 1,
      },
      {
        ...
        skillCode: 'LIFE_MONEY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Find a coin. 🪙',
        options: ['I found one!', 'Help me find one'],
        difficulty: 1,
        questionNumber: 2,
      },
      {
        ...
        skillCode: 'LIFE_SAFETY',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Hold my hand to cross the street. 🤝',
        options: ['I can do it!', 'Remind me'],
        difficulty: 1,
        questionNumber: 3,
      },
      {
        ...
        skillCode: 'LIFE_HYGIENE',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Wash your hands with soap. 🧼',
        options: ['I did it!', 'Help me'],
        difficulty: 1,
        questionNumber: 4,
      },
      {
        ...
        skillCode: 'LIFE_ORGANIZATION',
        questionType: 'MULTIPLE_CHOICE',
        questionText: 'Put the toy in the box. 🧸📦',
        options: ['I did it!', 'Show me how'],
        difficulty: 1,
        questionNumber: 5,
      },
 ...
 */
function getStubQuestions(domain: string, assessmentType: AssessmentType = 'STANDARD', count = 5) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      `[Baseline Questions] Generating ${domain} questions for ${assessmentType} assessment, grade band ${gradeBand}`
    );
    ...
    try {
      ...
      console.log(
        '[Baseline Questions] AI orchestrator not available, using stub questions:',
        error
      );
    }
    ...
    console.log(
      `[Baseline Questions] Using ${stubQuestions.length} stub questions for ${assessmentType}`
    );
