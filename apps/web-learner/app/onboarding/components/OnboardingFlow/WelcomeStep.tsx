  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <motion.div
        ...
        className="mb-8"
      >
        <div className="w-40 h-40 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-full flex items-center justify-center shadow-2xl">
      ...
      <motion.button
        ...
        className="mt-8 px-12 py-5 bg-gradient-to-r from-indigo-500 to-indigo-600
