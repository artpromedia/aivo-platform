...
export function AccessibilityStep({ data, onComplete, onBack }: OnboardingStepProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4">
      ...
      <div className="bg-white rounded-3xl shadow-xl p-6 border-2 border-[var(--aivo-teal-100)] space-y-4">
        {ACCESSIBILITY_OPTIONS.map((option, index) => (
          <motion.div
            ...
            className="p-4 rounded-xl border-2 border-[var(--aivo-neutral-100)] hover:border-[var(--aivo-purple-200)] transition-all"
          >
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-[var(--aivo-purple-50)] rounded-xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-[var(--aivo-neutral-500)] mb-3">
                  {option.description}
                </p>
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                          settings[option.id as keyof typeof settings] === opt.value
                            ...
                            : 'bg-[var(--aivo-neutral-100)] text-[var(--aivo-neutral-600)] hover:bg-[var(--aivo-purple-100)]'
                        }`}
                      >
                        {opt.label}
                      </button>
      ...
      <div className="mt-6 p-4 bg-[var(--aivo-teal-50)] rounded-2xl">
        <p className="text-sm text-[var(--aivo-teal-700)] text-center">
