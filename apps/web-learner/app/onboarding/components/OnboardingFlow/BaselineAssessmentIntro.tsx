    ...
    <div className="max-w-2xl mx-auto px-4">
      ...
      >
        <motion.div
          ...
          className="w-28 h-28 mx-auto bg-gradient-to-br from-[var(--aivo-teal-400)] to-[var(--aivo-brand-primary)] rounded-full flex items-center justify-center mb-6 shadow-xl"
        >
      ...
      <div className="bg-white rounded-3xl shadow-xl p-8 border-2 border-[var(--aivo-teal-100)]">
        <h3 className="text-xl font-bold text-[var(--aivo-brand-navy)] text-center mb-6">
        ...
        <div className="grid gap-4">
          {ASSESSMENT_FEATURES.map((feature, index) => (
            ...
            >
              ...
              <div>
                <h4 className="font-bold text-[var(--aivo-brand-navy)]">
                  {feature.title}
                </h4>
        ...
        <div className="mt-8 p-4 bg-gradient-to-r from-[var(--aivo-teal-50)] to-[var(--aivo-purple-50)] rounded-xl">
          <div className="flex items-center gap-3">
            <span className="text-2xl">💡</span>
            <p className="text-sm text-[var(--aivo-neutral-700)]">
      ...
      <div className="mt-8 flex justify-between items-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="px-12 py-5 bg-gradient-to-r from-[var(--aivo-teal-500)] to-[var(--aivo-brand-primary)]
