import { z } from 'zod';
export declare const HomeworkQuestionTypeSchema: z.ZodEnum<
  [
    'multiple_choice',
    'free_response',
    'math_expression',
...
export declare const HomeworkSubjectSchema: z.ZodEnum<
  ['math', 'science', 'english', 'history', 'geography', 'language_arts', 'social_studies', 'other']
>;
    ...
    payload: z.ZodObject<
      {
        ...
        errorType: z.ZodOptional<
          z.ZodEnum<
            ['conceptual', 'computational', 'careless', 'incomplete', 'formatting', 'unknown']
          >
        >;
...
export declare const HomeworkEventSchema: z.ZodDiscriminatedUnion<
  'eventType',
  [
    z.ZodObject<
      {
