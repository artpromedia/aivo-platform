import { z } from 'zod';
export declare const SelfReportedMoodSchema: z.ZodEnum<
  ['great', 'good', 'okay', 'frustrated', 'tired']
>;
export type SelfReportedMood = z.infer<typeof SelfReportedMoodSchema>;
export declare const FocusLossReasonSchema: z.ZodEnum<
  [
    'extended_idle',
    'rapid_switching',
...
export declare const FocusSampleSchema: z.ZodObject<
  {
    ...
    payload: z.ZodObject<
      ...
      z.ZodTypeAny,
      {
        learnerId?: string;
        sessionId?: string;
        gradeBand?: '4' | '1' | '2' | '3' | '5' | '6' | '7' | '8' | '9' | 'K' | '10' | '11' | '12';
        windowMs?: number;
        pingCount?: number;
        avgIdleMs?: number;
        maxIdleMs?: number;
    ...
    payload: z.ZodObject<
      {
        ...
        interventionSuggested: z.ZodOptional<
          z.ZodEnum<
            ['break_prompt', 'activity_switch', 'difficulty_adjust', 'encouragement', 'none']
          >
        >;
...
export declare const FocusEventSchema: z.ZodDiscriminatedUnion<
  'eventType',
  [
    z.ZodObject<
      {
