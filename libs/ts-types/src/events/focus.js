 ...
 */
export const FocusLossDetectedEventSchema = createEventSchema('focus.loss.detected', z.object({
 ...
 */
export const FocusInterventionTriggeredEventSchema = createEventSchema('focus.intervention.triggered', z.object({
 ...
 */
export const FocusInterventionCompletedEventSchema = createEventSchema('focus.intervention.completed', z.object({
