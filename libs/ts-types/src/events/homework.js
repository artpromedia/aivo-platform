 ...
 */
export const HomeworkTaskCreatedEventSchema = createEventSchema('homework.task.created', z.object({
 ...
 */
export const HomeworkTaskStartedEventSchema = createEventSchema('homework.task.started', z.object({
 ...
 */
export const HomeworkTaskCompletedEventSchema = createEventSchema('homework.task.completed', z.object({
 ...
 */
export const HomeworkStepCompletedEventSchema = createEventSchema('homework.step.completed', z.object({
 ...
 */
export const HomeworkHintRequestedEventSchema = createEventSchema('homework.hint.requested', z.object({
