 ...
 */
export const RecommendationCreatedEventSchema = createEventSchema(
 ...
 */
export const RecommendationRespondedEventSchema = createEventSchema(
 ...
 */
export const RecommendationAppliedEventSchema = createEventSchema(
