 ...
 */
export type PersonalizationSignalType = 'ENGAGEMENT' | 'DIFFICULTY' | 'FOCUS' | 'HOMEWORK' | 'MODULE_UPTAKE' | 'PREFERENCE' | 'PROGRESSION' | 'RECOMMENDATION';
export type PersonalizationSignalKey = 'LOW_ENGAGEMENT' | 'HIGH_ENGAGEMENT' | 'SESSION_TOO_SHORT' | 'SESSION_TOO_LONG' | 'HIGH_STRUGGLE_MATH' | 'HIGH_STRUGGLE_ELA' | 'HIGH_STRUGGLE_SCIENCE' | 'HIGH_STRUGGLE_SEL' | 'HIGH_STRUGGLE_SPEECH' | 'READY_FOR_CHALLENGE_MATH' | 'READY_FOR_CHALLENGE_ELA' | 'READY_FOR_CHALLENGE_SCIENCE' | 'READY_FOR_CHALLENGE_SEL' | 'READY_FOR_CHALLENGE_SPEECH' | 'HIGH_FOCUS_BREAKS' | 'LOW_FOCUS_BREAKS' | 'NEEDS_MORE_BREAKS' | 'INTERVENTION_RESPONSIVE' | 'INTERVENTION_UNRESPONSIVE' | 'HOMEWORK_AVOIDANCE' | 'HOMEWORK_HINT_HEAVY' | 'HOMEWORK_SELF_SUFFICIENT' | 'MODULE_HIGH_UPTAKE' | 'MODULE_LOW_UPTAKE' | 'PREFERS_MORNING' | 'PREFERS_AFTERNOON' | 'PREFERS_EVENING' | 'ACCELERATING' | 'DECELERATING' | 'PLATEAU' | 'REC_ACCEPTANCE_HIGH' | 'REC_ACCEPTANCE_LOW';
export type PersonalizationSignalSource = 'ANALYTICS_ETL' | 'ONLINE' | 'TEACHER_OVERRIDE' | 'PARENT_INPUT' | 'ASSESSMENT';
