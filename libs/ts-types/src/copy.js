...
export const parentCopy = {
    ...
    whyThis: {
        ...
        fallback: {
            noDetails: "Aivo used your child's recent work and learning goals to choose this activity. Detailed explanations aren't available for this one yet.",
            noExplanation: "We don't have a detailed explanation for this yet. Aivo used recent activity and goals to make this choice.",
            stillLearning: "We're still getting to know your learner. After a few sessions, we'll show more detailed insights here.",
        },
        intro: {
    ...
    // Disclaimers
    disclaimer: {
        aiLimits: 'Aivo uses AI to support learning. It can make mistakes and is not a medical or diagnostic tool.',
        suggestions: "Aivo's suggestions are based on patterns in your child's recent work. They may not always be perfect.",
        partnership: 'You know your child best. These suggestions work best when combined with your own observations.',
        notDiagnostic: 'Aivo is an educational tool, not a diagnostic system. It cannot identify or diagnose learning differences.',
    },
    // Empty states
    emptyState: {
        noActivity: "We're still getting to know your learner. After a few sessions, we'll show more detailed insights here.",
        noProgress: "Progress data will appear here after your child completes some activities. Every bit of practice helps build skills!",
        noInsights: "We're gathering information to provide helpful insights. Check back soon!",
    },
    // Error states
    error: {
        loadFailed: "We couldn't load the explanation right now. The activity will still work normally. Please try again later.",
...
export const teacherCopy = {
    ...
    whyThis: {
        ...
        fallback: {
            noDetails: 'This recommendation is based on recent learner activity and assessment data. Detailed reasoning is not available for this suggestion.',
            noExplanation: "Detailed explanation data isn't available. The suggestion is based on patterns in the learner's recent work.",
        },
        intro: {
    ...
    // Disclaimers
    disclaimer: {
        professionalJudgment: "Use your professional judgment. Aivo's suggestions are one input among many.",
        dataLimits: 'These insights are based on available data and may not capture the full picture of student learning.',
        notPrescriptive: 'These are suggestions, not prescriptions. You know your students best.',
        supplementary: 'AI-generated insights should supplement, not replace, your professional expertise and direct observations.',
    },
    // Empty states
    emptyState: {
        noData: "We don't have enough data yet to provide insights. After students complete a few activities, recommendations will appear here.",
        noRecommendations: 'No specific recommendations at this time. Continue with your planned instruction.',
        newStudent: "We're still gathering data for this student. Insights will become available as they complete more activities.",
    },
    // Error states
    error: {
        loadFailed: "We couldn't load the recommendation details. Please try refreshing the page.",
        syncFailed: 'Unable to sync the latest data. The information shown may not be current.',
    },
...
export const adminCopy = {
    // Model cards
    modelCard: {
        disclaimer: 'This system uses machine learning models. They may reflect biases in their training data. Aivo uses safety measures and policies to reduce harm, but residual risks remain.',
        limitations: {
    ...
    // Compliance
    compliance: {
        disclaimer: 'This dashboard provides an overview of AI system activity for compliance purposes. It does not constitute legal advice.',
        dataRetention: 'Data shown is subject to retention policies and may not include historical records beyond the retention period.',
    },
    // Error states
    error: {
...
export const sharedCopy = {
    ...
    difficulty: {
        ...
        descriptions: {
            ...
            decrease: 'Taking time to strengthen foundational skills before moving forward.',
