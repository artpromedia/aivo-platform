...
export function buildSkuCatalog() {
  ...
  const skus = {
    ...
    ADDON_SPEECH: {
      ...
      stripePriceIdMonthly: getEnvVar(
        'STRIPE_PRICE_ADDON_SPEECH_MONTHLY',
        'price_speech_monthly_test'
      ),
      stripePriceIdYearly: getEnvVar(
        'STRIPE_PRICE_ADDON_SPEECH_YEARLY',
        'price_speech_yearly_test'
      ),
    ...
    ADDON_SCIENCE: {
      ...
      stripePriceIdMonthly: getEnvVar(
        'STRIPE_PRICE_ADDON_SCIENCE_MONTHLY',
        'price_science_monthly_test'
      ),
      stripePriceIdYearly: getEnvVar(
        'STRIPE_PRICE_ADDON_SCIENCE_YEARLY',
        'price_science_yearly_test'
      ),
