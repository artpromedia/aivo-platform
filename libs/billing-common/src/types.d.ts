 ...
 */
export declare const SubscriptionStatusValues: readonly [
  'INCOMPLETE',
  'ACTIVE',
  'TRIALING',
  'PAST_DUE',
 ...
 * Invoice status
 */
export declare const InvoiceStatusValues: readonly [
  'DRAFT',
  'OPEN',
  'PAID',
  'VOID',
 ...
 */
export declare const CreateCouponRequestSchema: z.ZodEffects<
  z.ZodEffects<
    z.ZodObject<
      {
        code: z.ZodString;
