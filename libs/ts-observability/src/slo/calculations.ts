 ...
 */
export function calculateErrorBudgetMinutes(target: number, windowDays: number): number {
 ...
 */
export function calculateBurnRate(actualErrorRate: number, target: number): number {
 ...
 */
export function burnRateForExhaustion(hoursToExhaust: number, windowDays: number): number {
 ...
 */
export function evaluateSloCompliance(
  slo: SloDefinition,
  currentValue: number,
  elapsedDays: number
): SloComplianceResult {
  ...
  let status: SloComplianceResult['status'];
 ...
 */
export function generateErrorRateQuery(slo: SloDefinition, window: string): string {
  const { sli } = slo;
 ...
 * @returns PromQL query string
 */
export function generateBurnRateQuery(slo: SloDefinition, window: string): string {
 ...
 */
export function sloRecordingRuleName(sloId: string, type: 'error_rate' | 'burn_rate'): string {
